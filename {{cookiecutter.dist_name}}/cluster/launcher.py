...
_WANDB_PROJECT = flags.DEFINE_string("wandb_project", "{{ cookiecutter.package_name }}", "wandb project")
_WANDB_ENTITY = flags.DEFINE_string("wandb_entity", "{{ cookiecutter.github_username }}", "wandb user")
